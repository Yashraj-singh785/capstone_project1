...
class DataIngestion:
    ...
    def export_data_into_feature_store(self) -> DataFrame:
        ...
        """
        try:
            logging.info(f"Exproting data from mongodb")
            my_data = Proj1Data()
    ...
    def split_data_as_train_test(self,dataframe: DataFrame) -> None:
        ...
        On Failure  :   Write an exception log and then raise an exception
        """
        logging.info("Entered split_data_As_train_test method od Data_Ingestion class")
    ...
    def initiate_data_ingestion(self) -> DataIngestionArtifact:
        ...
        try:
            ...
            logging.info("Exicited initiate_data_ingestion method of Data_Ingestion class"
            )
